...
public class TankiClient {

	private JFrame frame = new JFrame ("Tanki :)");
	private JLabel messageLabel = new JLabel("");
	
	private JTextField powerTF = new JTextField();
	private JTextField angleTF = new JTextField();
	private JLabel powerLabel = new JLabel("power: ");
	private JLabel angleLabel = new JLabel("angle: ");
	
	private JButton shoot = new JButton("Strzelaj");
	...
	// Konstruktor obiektu klienta:
		// l¹czy z serwerem, buduje graficzny interfejs uzytkownika i rejestruje sluchaczy tego GUI
	
	public TankiClient(String serverAddress) throws Exception {
		...
		fieldsPanel.add(powerLabel);
		fieldsPanel.add(powerTF);
		fieldsPanel.add(angleLabel);
		fieldsPanel.add(angleTF);
