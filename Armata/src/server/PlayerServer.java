...
class PlayerServer extends Thread {
	...
	/**
	 * Konstruktor obiektów graczy. W momencie utworzenia obiektu do aplikacji
	 * klienta wys³ane zostaje powitanie "WELCOME" Koncepcja w kontekscie serwera: W
	 * momencie po³aczenia aplikacji klienta z serwerem tworzony jest obiekt gracza,
	 * przypisany zostaje token P1, lub P2, wys³ane powiadomienie do aplikacji
	 * klienta, oraz informacja którym "pionkiem" gracz bêdzie gra³.
	 * 
	 * @param socket
	 *            - port komunkacji
	 * @param token
	 *            - pionek z jakim gracz zaczyna grê np. P1, P2
	 * @param game
	 *            - plansza na której toczy siê gra
	 * @param xPos
	 *            - pozycja pocz¹tkowa gracza - oœ x
	 * @param yPos
	 *            - pozycja pocz¹tkowa gracza - oœ y
	 * @param hitpoints
	 *            - punkty wytrzymalosci
	 * 
	 * @author Robert Adamczuk
	 */
	...
	public PlayerServer(Socket socket, String token, GameServer game, double xPos, double yPos, int hitpoints) {
		...
		try {
			...
			// "WELCOME " - aplikacja KLIENTA bedzie szukac tego slowa w strumieniu danych z
			// serwera
	...
	// metody opponent.... obsluguja wiadomosci o ruchu przeciwnika i ewentualnych
	// konsekwencjach

	/**
	 * Motoda wywolywana po poprawnym trafieniu, po wystapieniu takiego zdarzenia
	 * sprawdzane sa warunki zwyciestwa
	 * 
	 * @author Robert Adamczuk
	 */
	public void opponentPlayerHit() {
		output.println("OPPONENT_HIT");
		// jesli uderzenie przeciwnika spowodowalo wygrana to wysyla wiadomosc o
		// przegranej
